...
def my_view(request):
    context = {"name": "John"}
    return render(request, "myapp4/my_template.html", context)


class TemplIf(TemplateView):
    template_name = "myapp4/templ_if.html"
...
def view_for(request):
    ...
    return render(request, 'myapp4/templ_for.html', context)
...
def about(request):
    return render(request, 'myapp4/about.html')
...
def post_full(request, post_id):
    ...
    return render(request, 'myapp4/post_full.html', {'post': post})
